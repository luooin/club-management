		...
		<div class="login-body">
			...
			<div class="login-form">
				<el-form :model="loginForm" :rules="rules" ref="loginForm">
					...
					<el-form-item>
						<el-button style="margin-top: 15px; width: 100%;background-color: #00aeda;"
							@click="submitForm('loginForm')" type="primary">用户登录</el-button>
						<el-link style="text-align:right;width: 100%;" @click="showAddWin()" :underline="false"
							type="info">没有账号，注册一个</el-link>
					</el-form-item>
				</el-form>
			</div>
		</div>
